...
3. **Install Plugin**
   - In the "... from URL" field, enter:
     ```
     https://github.com/yourusername/OctoPrint-PSUControl-Tapo-P110/archive/main.zip
     ```
   - Click "Install"
...
### Getting Help
- Check [GitHub Issues](https://github.com/yourusername/OctoPrint-PSUControl-Tapo-P110/issues)
...
pip install --upgrade "https://github.com/yourusername/OctoPrint-PSUControl-Tapo-P110/archive/main.zip"
sudo service octoprint restart
```
